...
\marginnote{Them? They were dead when I got 'ere. Natural shape for dwarves is that, two little shoes poking out of a helmet. Sniff.

}

\marginnote{Name: Thoth, Ug, Charlie, Caliban, Schtump, Stoor, Begbie}

\marginnote{Appearance (Pick 2): Hunchback; horns, no neck; huge shoulders; knuckle dragger; (broken)manacles; kilt; tattoos}  

\marginnote{Statistics: Start with \smallcaps{Fighter +3}. +1 and -1 to any of the others.
}
\marginnote{Job (Pick 1): Guard; Gladiator; Miner; Chef
}
\marginnote{Demon (Pick 3): Weakness; Stupidity; Chains; Accidental Harm; Electricity
}
...
\bigskip
Job(Pick 1): Jester; Informant; Messenger; Power Source
\bigskip

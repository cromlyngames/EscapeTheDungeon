...
When you draw on knowledge of the dungeon, or wake after a \smallcaps{long rest}, the dungeon presses in. You, as player, can say the thing you, as character,  know because of your role or job in the dungeon. You get that statement free. You can ask the GM to answer it, or just say something that fits the story. It might be where a key thing you need is stored, or who used to do a certain job. The GM needs to do their best to make it true. Now \smallcaps{roll + identity}
\begin{itemize}
...
So Faustus, you failed that roll and fell off the bridge, how exciting! lets leave you hanging in mid air and find out what Urg is doing in the library! So Urg, we left you searching through musty tomes looking for the recipie book to undo the tooth rot curse you baked into those fairy cakes. What ingredient does it require that fills you with dread?

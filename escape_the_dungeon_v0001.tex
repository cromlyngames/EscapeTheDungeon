...
\footnote{This is the stat to roll for breaking down doors, taking blows on a shield or arm-wrestling in the ork canteen. There is some blurriness with \smallcaps{thief}. Stabbing someone in a fight is a fighter move, but stabbing them in the back is a thief. Shooting a charging hero is direct violence and typically therefore \smallcap{fighter}, but trying to pull off a trick shot that pins their dagger hand to the wall might be \smallcaps{Thief}. The GM is encouraged to be relaxed about this, but encourage thought about the consequence of a miss. If players are pushing \smallcaps{thief} to try and avoid blowback damage, the GM should hit them with some very hard direct moves when a golden opportunity arrives. Players. I hope you read this.}
\begin{enumerate}
\begin{itemize}
...
\bigskip
Hobbies (fill in during play): _______________________________
...
When you take damage and reach your last health (1Hp), \samllcaps{mark xp} and resolve any new advances immediately. 
